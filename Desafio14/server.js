...
httpServer.listen(PORT, () => {
	console.log(`Example app listening on port http://localhost:${PORT}/public`);
});
...
routerProductos.get('/info', (req, res) => {
	const data = { args: args, os: process.platform, version: process.version, memory: process.memoryUsage().rss, path: process.execPath, id: process.pid, folder: process.cwd() };
	console.log(data);
